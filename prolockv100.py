...
class AttendanceApp:
    def __init__(self, root):
        ...
        # Create the heading frame to organize images and heading text
        heading_frame = ttk.Frame(self.main_frame, padding="10", style="ContainerFrame.TFrame")  # Use self.main_frame
        heading_frame.pack(fill="x")
        ...
        # Error Message Label
        self.error_label = tk.Label(self.main_frame, text="", font=("Helvetica", 10, "bold", "italic"), foreground="red", bg="#000000")  # Use self.main_frame
